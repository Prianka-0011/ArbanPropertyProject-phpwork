...
if ($conn -> connect_errno) {
  ...
  exit();
    ...
    $Sale="Sale";
    $query="select * from projecct Where Category='".$Sale. "' ";
    ...
    <header class="project-header">
        ...
        <div class="overlay">
            ...
            <div class="container text-center project-heading">
                <h1 class="heading text-center text-uppercase">Sale <span class="mddle">Project </span><span class="last">Heare</span> </h1>
            </div>
        </div>
