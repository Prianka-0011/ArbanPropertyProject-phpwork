...
if ($conn -> connect_errno) {
  ...
  exit();
    ...
    $Rent="Rent";
    $query="select * from projecct Where Category='".$Rent. "' ";
    ...
    <header class="project-header">
        ...
        <div class="overlay">
            ...
            <div class="container text-center project-heading">
                <h1 class="heading text-center text-uppercase">Rent <span class="mddle">Project </span><span class="last">Heare</span> </h1>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-12 col-lg-4">
                    <div class="project-card frist-proj">
                        <div class="proj-card-img">
                        <a href="projectdetail.php?Id=<?php echo $res['Id']; ?>">
                            <img src="<?php echo $res['Galary1'] ?>" alt="">
                        </a>
                        </div> 
                        <div class="proj-card-body text-center">
